...
namespace TriResultsCsvReader
{
    public class ResultsReaderCsv
    {
        ...
        //public IEnumerable<ResultRow> ReadFile(string csvFilename, IWhitelistFilter filterList = null, Expression<Func<ResultRow, IWhitelistFilter, bool>> filter = null)
        //{
        ...
        //            records = records.Where(r => compiledFilter.Invoke(r, filterList));
        //        }
